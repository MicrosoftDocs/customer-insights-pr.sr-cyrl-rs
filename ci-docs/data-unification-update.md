...
1. Са странице **"** > **Уједињење података** " изаберите:
   ...
   - **Уједините профиле клијената** : Покреће услове подударања и ажурира обједињени ентитет профила корисника без утицаја на зависности (као што су обогаћивања, сегменти или мере). Зависни процеси се не покрећу, али ће бити освежени као што је дефинисано [у распореду освежавања](schedule-refresh.md).
