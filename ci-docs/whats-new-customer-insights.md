...
Више информација потражите у чланку [Безбедан приступ подацима клијената помоћу оквира за закључавање клијента (Превиеw)](security-overview.md#securely-access-customer-data-with-customer-lockbox-preview).
...
Више информација потражите у чланку Коришћење [приватне везе у увидима клијената](security-overview.md#private-links-tab).
