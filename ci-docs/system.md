...
1. **Изаберите временски оквир** за приказ.
   ...
   Операције које користе [уношење података у реалном времену](real-time-data-ingestion.md) садрже двогледни симбол за приказ употребе АПИ-ја у реалном времену.

   1. Изаберите двоглед да бисте отворили окно **за коришћење АПИ-ја у реалном** времену које садржи детаље о коришћењу операције.
   1. **Изаберите временски оквир** за приказ.
   1. Користите поље **"Групиши** по" да бисте одабрали како да на најбољи начин представите интеракције у реалном времену. Податке груписање по АПИ методу, квалификованом имену ентитета **(унети ентитет),** креираном **по (извору догађаја),** резултату (успеху **или неуспеху) или кодовима** грешака **.** **·** Подаци су доступни као временски графикон и табела.
