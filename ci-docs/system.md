---
title: Конфигурација система у увидима клијената
...
ms.locfileid: "8653634"
---
# <a name="system-configuration"></a>Конфигурација система

Да бисте приступили конфигурацијама система, посетите **АдминСyстем** > **да** бисте приказали листу системских задатака и процеса.
...
1. Идите на **АдминСyстем** > **и изаберите** картицу **"Распоред** ".
