...
**Плочица профила клијента**: Ова плочица приказује различите вредности обједињеног ентитета *Клијент*. Ако поље нема вредност за изабрани профил клијента, неће се приказати. Плочица је структурирана у делове:
