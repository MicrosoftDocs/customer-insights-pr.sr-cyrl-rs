...
1. Мапирајте семантичка поља са атрибутима у ентитету историје куповине и изаберите **Следеће**. За опис поља погледајте [предуслове](#prerequisites).
   > [!div class="mx-imgBorder"]
   > ![Дефинисање релације између ентитета.](media/product-recommendation-purchasehistorymapping.PNG "Страница историје куповине која приказује семантичке атрибуте који су мапирани у поља у изабраном ентитету историје куповине")
