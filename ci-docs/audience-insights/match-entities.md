...
|Мапирање псеудонима    | Дефинисање вредности које систем треба да узме у обзир као исту вредност.         | Сматрај *да* је Дћо једнак са *Дћозефом.*        |
...
1. Одаберите прилагођену опцију подударања из **падајуће листе** прилагођеног типа и изаберите **ставку Преузми предложак**. Потребан вам је посебан предложак за сваку опцију подударања.

1. Датотека предлошка се преузима. Отворите га и попуните детаље. Предложак садржи поља за спецификацију ентитета и вредности примарног кључа ентитета које ће се користити у прилагођеном подударању. На пример, ако желите да се примарни кључ *12345* из ентитета *Продаја* увек подудара са примарним кључем *34567* из ентитета *Контакт*, попуните предложак:
    - Entity1: Продаја
    - Entity1Key: 12345
    - Entity2: Контакт
    - Entity2Key: 34567
...
1. Када отпремите датотеке и ентитете који су доступни, поново изаберите опцију **Прилагођено подударање**. Видећете опције за одређивање ентитета које желите да укључите. У падајућем менију изаберите потребне ентитете и изаберите ставку **Готово**.
...
1. Примена прилагођеног подударања зависи од опције подударања коју желите да користите. 
   ...
   - За **прилагођено** **премошћавање или мапирање** псеудонима изаберите **опцију** Уреди по постојећем правилу подударања или креирајте ново правило. У падајућем менију Нормализације одаберите опцију **Мапирање** прилагођеног **бајпаса или псеудонима** и изаберите **готово**.
...
Када довршите процес подударања за најмање један пар подударања, пређите на корак [**·**](merge-entities.md) обједињавања.
