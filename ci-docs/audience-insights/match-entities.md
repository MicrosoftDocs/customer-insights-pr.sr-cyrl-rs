...
Поред обједињеног главног ентитета креираног као део подударања са ентитетима, поступак уклањања дупликата такође генерише нови ентитет за сваки ентитет из редоследа подударања како би се идентификовали записи из којих су уклоњени дупликати. Ови ентитети се могу наћи заједно са **ConflationMatchPairs:CustomerInsights** у одељку **Систем** на страници **Ентитети**, са именом **Deduplication_Datasource_Entity**.
...
- **Деактивирајте правило** да задржите правило подударања док га искључујете из процеса подударања.
  ...
  > [!div class="mx-imgBorder"]
  > ![Деактивирање правила](media/configure-data-deactivate-rule.png "Деактивирање правила")
