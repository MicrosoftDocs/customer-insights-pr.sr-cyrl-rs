...
- Да би се ваши Dynamics 365 подаци мапирали у корисничке профиле увида у циљну групу, они треба да буду [унети из Dynamics 365 апликације помоћу Common Data Service конектора](connect-power-query.md).
