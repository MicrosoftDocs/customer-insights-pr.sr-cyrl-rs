...
- Да би се Ваши Дyнамицс 365 подаци мапирали на корисници увида у профиле клијената, потребно их је [унети из Дyнамицс 365 апликације помоћу Мицрософт Датаверсе конектора](connect-power-query.md).
...
- Свака контрола програмског додатка ослања се на одређене податке у увидима у циљну групу. Неки подаци и контроле доступни су само у одређеним типовима окружења. Конфигурација програмског додатка ће вас обавестити ако контрола није доступна због изабраног типа окружења. Сазнајте више о [случајевима употребе окружења](work-with-business-accounts.md).
  ...
  - **Контрола обогаћивања**: Захтева да се активна [обогаћивања](enrichment-hub.md) примене се на профиле клијената. Програмски додатак за картице подржава ова обогаћивања: [...](enrichment-microsoft.md) брендове које обезбеђује Мицрософт, [...](enrichment-microsoft.md) интересовања која обезбеђује Мицрософт.
...
Програмски додатак за картицу клијента је решење за Customer Engagement апликације у систему Dynamics 365. Да бисте инсталирали решење, идите на АппСоурце и потражите **Дyнамицс Картицу купца**. Изаберите [програмски додатак "Картица купца" АппСоурце](https://appsource.microsoft.com/product/dynamics-365/mscrm.dynamics_365_customer_insights_customer_card_addin?tab=Overview) изаберите [ставку Донеси одмах](https://appsource.microsoft.com/product/dynamics-365/mscrm.dynamics_365_customer_insights_customer_card_addin?tab=Overview).
...
1. Изаберите **име за приказ** везу за Дyнамицс 365 Цустомер Инсигхтс **програмски додатак за картицу купца (Превиеw).**
