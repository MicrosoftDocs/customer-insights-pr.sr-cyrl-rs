...
1. У области конфигурације, одаберите функцију агрегације из падајућег менија **Изабери функцију**. Агрегатне функције укључују: 
   - **Sum**
   - **Просек**
   - **Број**
   - **Број јединствених**
...
1. Ако у вашим подацима постоје вредности које треба да замените целим бројем – на пример, да замените *null* са *0* – изаберите **Правила**. Конфигуришите правило и обавезно одаберите само целе бројеве као замену.
