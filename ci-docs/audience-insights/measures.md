...
Овај одељак вас води кроз креирање нове мере од почетка. Можете да направите меру са атрибутима података из ентитета података који имају успостављен однос за повезивање са обједињеним ентитетом профила клијента.
