...
6. Опционално, можете да наведете URL адресу Microsoft Dataverse окружења у одељку **Конфигуришите дељење података са платформом Microsoft Dataverse и омогућите додатне могућности**. Ове могућности укључују дељење података са апликацијама и решењима заснованим на платформи Microsoft Dataverse, уношење података из локалних извора података или употребу [предвиђања](predictions.md). Изаберите **Омогући дељење података** да бисте делили Customer Insights излазне податке помоћу платформе Microsoft Dataverse Managed Data Lake.
   ...
   Када омогућите дељење података са платформом Microsoft Dataverse, биће покренуто потпуно освежавање извора података и других процеса. Ако се процеси тренутно изводе и налазе се у реду, нећете видети опцију за омогућавање дељења података са платформом Microsoft Dataverse. Можете сачекати да се ти процеси доврше или отказати да бисте омогућили дељење података. 
