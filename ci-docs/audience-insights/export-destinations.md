...
- **Извоз излазних података** омогућава вам да извезете било коју врсту ентитета доступну у увидима у циљну групу. Ентитети које изаберете за извоз извозе се са свим пољима података, метаподацима, шемама и детаљима мапирања. 
- **Извоз по сегментима** вам омогућава да извозите ентитете сегмената из увида у циљну групу. Сегменти представљају листу профила клијената. Приликом конфигурисања извоза бирате обухваћена поља података, у зависности од циљног система у који извозите податке. 

### <a name="export-segments"></a>Извоз сегмената

**Извоз сегмената у окружења за пословне налоге (B2B) или појединачне клијенте (B2C)**  
Већина опција извоза подржава оба типа окружења. Извоз сегмената у различите циљне системе има посебне захтеве. Уопштено говорећи, члан сегмента, профил клијента, садржи контакт информације. Иако је то обично случај са сегментима изграђеним на индивидуалним клијентима (B2C), то није нужно случај са сегментима заснованим на пословним налозима (B2B). 

**Окружења извоза сегмената за пословне налоге (B2B)**  
...
**Сегментирајте извозе у окружењима за индивидуалне клијенте (B2C)**  
