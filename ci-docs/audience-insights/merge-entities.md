...
1.  Можете додати додатна поља за учешће у процесу спајања.
...
CustomerId у ентитету Клијент заснован је на хешу прве вредности примарних кључева који немају вредност „null“. Ови кључеви потичу од ентитета који се користе у фази подударања и спајања и на њих утиче редослед подударања. Тако се генерисани CustomerID може променити када се промени вредност примарног кључа у примарном ентитету редоследа подударања. Последично, вредност примарног кључа можда не представља увек истог клијента.
...
1. На страници **Споји**, изаберите картицу **Кључеви**. 
