...
1. У кораку **Релација** конфигуришите детаље за повезивање података о активностима са одговарајућим клијентом. Овај корак визуализује везу између ентитета.  
   ...
   - **Трећи**: Ако релација између овог ентитета активности и изабраног изворног ентитета клијента већ постоји, назив релације ће бити у режиму само за читање. Ако таква релација не постоји, креираће се нова релација под називом који наведете у овом пољу.
...
1. У кораку **Обједињавање активности**, одаберите догађај активности и време почетка активности. 
   - **Обавезна поља**
      1. **Активност догађаја**: Поље које је догађај за ову активност
      2. **Временска ознака**: Поље које представља време почетка ваше активности.

   - **Опционална поља**
      1. **Додатни детаљ**: Поље са релевантним информацијама за ову активност.
      2. **Икона**: Икона која најбоље представља ову врсту активности.
      3. **Веб-адреса**: Поље које садржи URL адресу са информацијама о овој активности. На пример, трансакциони систем који је извор ове активности. Ова URL адреса може бити било које поље из извора података или се може направити као ново поље помоћу Power Query трансформације. Подаци о URL адреси биће сачувани у ентитету *Обједињена активност*, који се може последично користити помоћу [API-ја](apis.md).
...
- **Преименуј**: Отвара дијалог у који ћете унети други назив за изабрану активност. Изаберите **Сачувај** да примените промене.
