...
2 – Одаберите [путању релације](relationships.md) између ентитета која се примењује на правило. Путања релације одређује који се атрибути могу користити у услову.

3 – Управљајте правилима и подправилима. Промените положај правила или га избришите.

4 – Додајте услове и изградите одговарајући ниво угнежђавања помоћу подправила.

5 – Примените задате операције на повезана правила.

6 – Користите окно са атрибутима да бисте додали доступне атрибуте ентитета или креирали услове на основу атрибута. Окно приказује листу ентитета и атрибута, на основу изабране путање релација, који су доступни за изабрано правило.

7 – Додајте услове на основу атрибута у постојећа правила и подправила или их додајте у ново правило.

8 – Опозовите и поновите промене током изградње сегмента.
...
Постоји више начина за креирање новог сегмента. Овај одељак описује како да направите свој сегмент од нуле. Такође можете да креирате *брзи сегмент* на основу постојећих ентитета или искористите моделе машинског учења да бисте добили *предложене сегменте*. Још информација: [Преглед сегмената](segments.md).
...
1. На страници за прављење сегмената дефинишете прво правило. Правило се састоји од једног или више услова и дефинише скуп клијената.
...
1. Ако у правилу имате више услова, можете одабрати који их логички оператор повезује.
   ...
   1. Можете да креирате више правила да бисте креирали различите скупове записа о клијентима. Можете комбиновати групе да бисте укључили клијенте потребне за ваш пословни предмет. Да бисте креирали ново правило, изаберите **Додај правило**. Конкретно, ако не можете да укључите ентитет у правило због наведене путање релација, морате да креирате ново правило да бисте изабрали атрибуте који га образују.
...
1. Подразумевано, сегменти генеришу излазни ентитет који садржи све атрибуте профила клијената који одговарају дефинисаним филтерима. Ако се сегмент заснива на другим ентитетима осим на ентитету *Клијент*, излазном ентитету можете додати више атрибута из тих ентитета. Изаберите **Атрибути пројекта** да бисте одабрали атрибуте који ће бити додати излазном ентитету.  
   ...
   > - Атрибуте можете пројектовати само из ентитета који се користи у сваком правилу упита сегмента који правите.
...
1. Изаберите **Покрени** да бисте сачували и обрадили сегмент ако су сви захтеви потврђени. У супротном, биће сачуван као неактивна радна верзија сегмента.
...
> - Ако имате више правила за сегмент, видећете плаву траку око правила које уређујете.
...
> - Контроле **Поништи** и **Понови** на командној траци вам омогућавају да вратите промене.
