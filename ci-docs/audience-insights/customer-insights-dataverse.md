...
Администратори могу да конфигуришу увиде клијената [тако да користе постојеће Dataverse](create-environment.md) окружење када креирају окружење "Увиди купаца". Навођењем URL адресе за Dataverse окружење, везује се за њихово ново окружење за увиде у циљну групу. Увиди клијената Dataverse и окружења морају бити хостована у истом региону. 
