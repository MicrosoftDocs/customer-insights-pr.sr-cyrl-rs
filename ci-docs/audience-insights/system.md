...
ms.locfileid: "8354251"
---
# <a name="system-configuration"></a>Конфигурација система

Да бисте приступили конфигурацијама система корисници увидима, са леве траке за навигацију **изаберите АдминСyстем** > **да** бисте приказали листу системских задатака и процеса.
...
> [!NOTE]
> Изворе података којима управљате освежавате по сопственим распоредима. Да бисте испланирали освежавање извора података којима управљате, конфигуришите поставке освежавања на том одређеном извор података са странице **извора података**.
