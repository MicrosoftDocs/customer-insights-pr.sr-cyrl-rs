...
1. Изаберите **Управљање извозима** из падајуће листе радњи.

1. Отвара се страница **Извози (преглед) за сегмент**. Можете да видите све конфигурисане извозе груписане према извозима који садрже тренутни сегмент или га не садрже.

   1. Да бисте изабрани сегмент додали у извоз, изаберите извоз на листи и изаберите **Додај сегмент**.
