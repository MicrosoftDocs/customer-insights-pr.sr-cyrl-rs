...
2. Изаберите **Ново** > **Празан сегмент**.

3. У окну **Нови сегмент** одаберите тип сегмента и наведите **Име**.

   Опционално, унесите име за приказ и опис који помаже у препознавању сегмента.

4. Изаберите **Следеће** да дођете на страницу **Градитељ сегмената** на којој дефинишете групу. Група је скуп клијената.

5. Одаберите ентитет који обухвата атрибуте по којима желите да сегментирате.

6. Одаберите атрибут по сегменту. Овај атрибут може имати један од четири типа вредности: нумерички, ниска, датум или логички.

7. Одаберите оператор и вредност за изабрани атрибут.
...
9. Изаберите **Сачувај** да бисте сачували сегмент. Ваш сегмент ће бити сачуван и обрађен уколико су сви захтеви потврђени. У супротном, биће сачуван као радна верзија.

10. Изаберите **Назад на сегменте** да бисте се вратили на страницу **Сегменти**.
