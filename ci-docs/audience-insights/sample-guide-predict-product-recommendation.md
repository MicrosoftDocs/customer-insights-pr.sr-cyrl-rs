...
---
# <a name="product-recommendation-prediction-preview-sample-guide"></a>Пример водича за предвиђање препорука производа (преглед)
...
2. На падајућој листи **Примарно**, одаберите **eCommerce контакти: eCommerce** као примарни извор и укључите све записе.

3. На падајућој листи **Ентитет 2**, одаберите **Лојални клијенти: Шема лојалности** и укључите све записе.
...
1. Дефинишите три услова за модел:
   ...
   - **Предлажете производе које су клијенти недавно купили?**: Изаберите **Да** како бисте назначили да желите да додате производе у препоруку коју су ваши клијенти раније купили.
