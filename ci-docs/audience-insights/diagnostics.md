...
- Имате администраторске [дозволе](permissions.md#administrator) у фасцикли "Увиди клијената".
...
| `properties.operationType`                   | Да      | Да  | Идентификатор операције погледајте [Типови операција]. (#оператион типови)                                                                                                                                                                                       |
