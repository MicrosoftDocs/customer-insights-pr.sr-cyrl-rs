...
ms.locfileid: "9170653"
---
# <a name="create-complex-segments-with-segment-builder"></a>Креирање сложених сегмената помоћу израде сегмената

Дефинишите сложене филтере око јединственог ентитета клијента и са њим повезаних ентитета. Сваки сегмент након обраде креира скуп корисничких записа које можете да извозити и за које можете да предузимате неке кораке.
...
1. По подразумеваној вредности, излазни ентитет ће аутоматски садржати све атрибуте профила клијената који се подударају са дефинисаним филтерима. Ако је сегмент заснован на другим ентитетима осим на ентитету *купца*, **изаберите атрибуте** пројекта да бисте излазном ентитету додали више атрибута из ових ентитета.

   > [!IMPORTANT]
   > За сегменте засноване на пословним налозима, детаљи једног или више контаката *сваког конта из ентитета ЦонтацтПрофиле* морају бити укључени у сегмент да би се омогућило активирање или извоз тог сегмента на одредишта која захтевају контакт информације. Више информација о ентитету *ContactProfile* потражите у чланку [Семантичка мапирања](semantic-mappings.md).
