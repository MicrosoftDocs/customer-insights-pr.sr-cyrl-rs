...
1. За сваки **Унос веб-услуге**, изаберите одговарајући **Ентитет** из услуге Customer Insights и изаберите **Следеће**.
   > [!NOTE]
...
1. Видећете екран **Ток посла је сачуван** са детаљима о току посла.    
   Ако сте конфигурисали ток посла за Азуре Машинско учење гасовод, "Увиди купаца" се прилажу радном простору који садржи цевовод. Увиди клијената ће добити **сарадник улогу** на Азуре радном простору.
...
1. На страници"Прилагођени **модели" изаберите вертикалну елипсу (**) у колони "Радње &vellip; " **поред тока посла који сте претходно креирали и изаберите ставку Уреди** **.**
...
1. За сваки **унос Wеб услуге** можете да ажурирате одговарајући ентитет из **увида** клијената. Затим изаберите **Следеће**.
...
1. На страници **"Прилагођени** модели" изаберите вертикалну елипсу (&vellip;) у **колони "** Радње" поред тока посла који сте претходно креирали.

1. Изаберите **Покрени**.

Ток посла се такође покреће аутоматски са сваким заказаним освежавањем. Сазнајте више о [постављању заказаних освежавања](schedule-refresh.md).
