...
- Окружење мора бити конфигурисано за појединачне потрошаче **примарне** циљне корисници.
...
1. Након мапирања активности на одговарајући семантички тип, кликните на дугме"Даље" **да бисте** наставили.
...
1. У кораку **Филтери за производе**, одаберите између следећих опција.
