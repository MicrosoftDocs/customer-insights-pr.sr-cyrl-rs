...
> [!TIP]
> Смањите време обраде извоза сегмената са следећим најбољим праксама:
> - Дистрибуирајте ентитете сегмента по извозу мутиплеа.
> - Избегавајте истовремено планирање свих извоза. Оставите 30 минута или један сат између планираног времена сваког извоза.
