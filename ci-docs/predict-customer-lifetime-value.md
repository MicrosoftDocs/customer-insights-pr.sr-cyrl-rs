...
1. У додатном **кораку података (опционално)** изаберите ставку Додај **податке у** оквиру **Увид модела Боост са додатним подацима о активностима**. Изаберите ентитет активности клијента који пружа информације о активностима клијената како је описано у [предусловима](#prerequisites).
...
1. Додај опционалне податке о купцима или кликните на дугме **"Даље"**.
...
1. У додатном **кораку података (опционално)** изаберите ставку Додај **податке у** **оквиру Боост увид модела још више са додатним подацима о клијентима**.

1. За ентитет **одаберите** опцију " **Купац: Кориснички садржаји" да бисте изабрали** обједињену табелу профила купца која се мапира на податке атрибута купца. За **ИД купца** изаберите ставку ИД **купца система.Купац** ..
...
1. Изаберите **ставку** Сачувај након мапирања атрибута које модел треба да користи да би се предвидела вредност доживотног трајања клијента.
