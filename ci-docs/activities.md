...
1. У кораку **подаци о** активности унесите следеће информације:
   ...
   - **Примарни кључ**: Изаберите поље које јединствено идентификује запис. Оно не би смело да садржи дупликате, празне вредности или вредности које недостају.
     ...
     > [!NOTE]
     > Примарни кључ за сваки ред мора остати доследан у извор података освежава. Ако се примарни кључ за ред ажурира у освежавању извор података, он креира дупликате у излазном ентитету активности. 
