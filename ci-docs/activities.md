...
Комбинујте активности клијента из [разних извора података](data-sources.md) у услузи Dynamics 365 Customer Insights. Креирајте временску осу која хронолошки наводи активности. Укључите временску осу у Дyнамицс 365 апликације са решењем [програмског додатка "Картица купца](customer-card-add-in.md) ".
...
Ако је клијент учествовао у конфигурисаној активности, пронаћи ћете је у одељку Временска оса **активности**.
