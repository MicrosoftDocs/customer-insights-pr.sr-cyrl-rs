...
Dynamics 365 Customer Insights обезбеђује опцију повезивања са налогом Azure Data Lake Storage помоћу главне Азуре услуге уместо кључева налога за складиштење.

Аутоматизоване алатке које користе Азуре услуге морају имати ограничене дозволе. Уместо да се апликације пријављују као потпуно привилеговани корисник, Azure нуди принципале услуга. Користите директоре услуга да бисте безбедно додали [или уредили фасциклу "Уобичајени модел података" извор података](connect-common-data-model.md) или креирали [или ажурирали окружење](create-environment.md).

## <a name="prerequisites"></a>Предуслови

- Дата Лаке Стораге налог који ће користити главницу услуге мора бити Gen2. Азуре Дата Лаке Gen1 налози за складиштење нису подржани.
- Дата Лаке Стораге налог има [омогућен хијерархијски простор за име](/azure/storage/blobs/data-lake-storage-namespace).
- Администраторске дозволе за Азуре закупац, ако морате да креирате новог директора услуге.

## <a name="create-an-azure-service-principal-for-customer-insights"></a>Креирање принципала услуге Azure за Customer Insights

Пре него што креирате новог директора сервиса за увиде клијената, проверите да ли он већ постоји у вашој организацији. У већини случајева већ постоји.
...
5. Ако пронађете одговарајући запис, то значи да принципал услуге већ постоји. [Доделите дозволе](#grant-permissions-to-the-service-principal-to-access-the-storage-account) директору услуге за приступ налогу за складиштење.
...
6. Ако резултати не буду враћени, [креирајте новог директора услуге](#create-a-new-service-principal).
...
Да бисте доделили дозволе директору услуге за налог за складиштење који желите да користите у програму Цустомер Инсигхтс, једна од следећих улога мора бити додељена налогу за складиштење или контејнеру:

|Акредитив|Захтеви|
|----------|------------|
|Тренутно пријављени корисник|**Улога** : Складиштење Блоб података читалац, Стораге Блоб сарадник или Стораге Блоб Оwнер.<br>**Ниво** : Дозволе додељене на налогу за складиштење или контејнеру.</br>|
|Главница услуге увида купаца -<br>Коришћење Azure Data Lake Storage као извор података</br>|Опција 1<ul><li>**Улога** : Складиштење Блоб података читалац, Стораге Блоб Дата сарадник или Стораге Блоб Власник података.</li><li>**Ниво** : Дозволе додељене на налогу за складиштење.</li></ul>Опција 2 *(без дељења услуге Принципални приступ налогу за складиштење)*<ul><li>**Улога 1** : Стораге Блоб Дата читалац, Стораге Блоб Дата сарадник или Стораге Блоб Дата Оwнер.</li><li>**Ниво** : Дозволе додељене у контејнеру.</li><li>**Улога 2** : Делегатор података блоб складишта.</li><li>**Ниво** : Дозволе додељене на налогу за складиштење.</li></ul>|
|Главница услуге увида купаца - <br>Коришћење Azure Data Lake Storage као излаз или одредиште</br>|Опција 1<ul><li>**Улога** : Складиштење Блоб података сарадник власник складишта блоба.</li><li>**Ниво** : Дозволе додељене на налогу за складиштење.</li></ul>Опција 2 *(без дељења услуге Принципални приступ налогу за складиштење)*<ul><li>**Улога** : Складиштење Блоб података сарадник власник складишта блоба.</li><li>**Ниво** : Дозволе додељене у контејнеру.</li><li>**Улога 2** : Делегатор складишта Блоб.</li><li>**Ниво** : Дозволе додељене на налогу за складиштење.</li></ul>|
...
1. У окну **Додај доделу улоге** подесите следећа својства:
   ...
   - **Додели приступ** : кориснику **, групи или директору услуге**
...
Приложите дата Лаке Стораге налог у увидима клијената да бисте ускладиштили [излазне](manage-environments.md) податке [или их користили као извор података](connect-dataverse-managed-lake.md). Одаберите између приступа [заснованог на ресурсима](#resource-based-storage-account-connection) или приступа [заснованог на претплати](#subscription-based-storage-account-connection) и следите те кораке.
